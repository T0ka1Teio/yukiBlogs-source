...
def main():
    ...
    files_to_update = [
        ...
        "myBlogs/app/page.tsx", "myBlogs/components", "myBlogs/lib", "myBlogs/public", "myBlogs/app/tree",
        ...
        "my-blog-manager/components", "my-blog-manager/lib", "my-blog-manager/context", "my-blog-manager/app/tree",

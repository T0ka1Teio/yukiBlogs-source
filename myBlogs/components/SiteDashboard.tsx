...
export default function SiteDashboard() {
  ...
  return (
    // 横向铺满 12 列的长条矩阵
    <div className="md:col-span-12 rounded-3xl bg-white/40 dark:bg-slate-800/50 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-xl overflow-hidden flex flex-col md:flex-row items-stretch transition-colors duration-700 h-auto md:min-h-20 lg:h-20 group">
      ...
      {/* 中间与右侧：桌面端与控制台保持同一条横向状态栏 */}
      <div className="flex-1 px-6 py-4 lg:py-0 flex flex-wrap lg:flex-nowrap items-center justify-between gap-4 text-xs md:text-sm font-bold text-slate-600 dark:text-slate-300">
        ...
        {siteConfig.icpConfig && (
          <a
            ...
            className="shrink-0 hover:text-indigo-500 transition-colors border-b border-dashed border-slate-400 dark:border-slate-500 pb-0.5"
          >

...
async function getPostData(slug: string, runtimeSiteConfig: typeof siteConfig) {
  const fullPath = path.join(contentRoot, 'posts', `${slug}.md`);
...
export default async function Post({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const postData = await getPostData(resolvedParams.slug, runtimeSiteConfig);

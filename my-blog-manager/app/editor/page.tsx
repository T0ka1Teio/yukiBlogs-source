...
import { createOperation, useOperations } from '../../context/OperationContext';
...
function EditorContent() {
    ...
    if (isPublish) {
      ...
      if (docType === 'about') {
        ...
        try {
          ...
          showToast("✅ 关于页已更新并同步本地前端；线上站点请再执行源码同步触发 EdgeOne", "success");
          router.push('/about');
          router.refresh();
        } catch (error) {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden relative">
      ...
      <FloatingImageTool sourceMode="photowall" isOpen={isImgToolOpen} onClose={() => setIsImgToolOpen(false)} onInsert={(url) => {

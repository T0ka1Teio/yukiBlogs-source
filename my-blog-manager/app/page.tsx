...
export default function Home() {
  const { albums } = getRuntimeContent();
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full items-stretch">
                ...
                <div className="md:col-span-8 flex flex-col gap-6 h-full">
                  <div className="w-full">
                    <Link href="/photowall" className="block w-full rounded-3xl bg-white/40 dark:bg-slate-800/50 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-xl overflow-hidden transition-all duration-700 hover:scale-[1.02] relative group min-h-[200px] md:min-h-[220px]">

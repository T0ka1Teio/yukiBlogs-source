...
import { loadGitalkRuntimeConfig } from './gitalkRuntime';
...
export default function Comments() {
  ...
  useEffect(() => {
    ...
    void loadGitalkRuntimeConfig().then((config) => {
      if (cancelled) return;
      if (!config.clientID || !config.repo || !config.owner) {
        container.textContent = '请先在设置中完成 GitHub OAuth 与评论仓库配置。';
        return;
      }

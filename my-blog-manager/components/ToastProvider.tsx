...
const TOAST_Z_INDEX = 2_147_483_001;
      ...
      <AnimatePresence>
        {toastMsg && (
          <motion.div
            ...
            className={`fixed top-20 left-1/2 -translate-x-1/2 px-6 py-3 rounded-2xl shadow-2xl flex items-center gap-3 backdrop-blur-xl border
